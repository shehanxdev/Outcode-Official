    ...
    return (
        <>
            <div className="portfolio-style-one-item">
                ...
                <div className="info">
                    <h2><Link to={`/portfolio-details/${id}`}>{text} <strong>{textBold}</strong></Link></h2>
                    <Link className="btn-animation mt-30" to={`/portfolio-details/${id}`}><i className="fas fa-arrow-right" /> <span>See Details</span></Link>
                </div>
            </div>
        </>
    );
