...
const AccordionV1Modal = () => {

    return (
        <>
            {AccordionV1Data.map(data =>

                <div className="popup-single-modal modal fade" id={data.modalId} tabIndex={-1} aria-hidden="true">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12">
                                                <div className="project-details-thumb">
                                                    <img src={`/assets/img/portfolio/${data.thumbFull}`} alt="Image Not Found" />
                                                </div>
                                            </div>
...
export default AccordionV1Modal;